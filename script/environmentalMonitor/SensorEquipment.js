                    ...
                    $.each(landDeverData.data, function (index, item) {
                        if (deviceId == item.DeviceID) {
                            if (item.Slots[0].Alarm) {
                                // console.log(item.Slots[0].Alarm);
                                var index = ""
...
function alermSure() {
    ...
    var index = $(".layui-tab-content .layui-tab-item").index($(".layui-tab-content .layui-show"));
    var value1 = $(".layui-tab-content .layui-show").find("input").eq(0).val();
    var value2 = $(".layui-tab-content .layui-show").find("input").eq(1).val();
    if (index == 0 && !(!!value1 && !isNaN(value1))) {
        ...
        return false;
    } else if (index == 2 && (!(!!value2 && !isNaN(value2)) || !(!!value1 && !isNaN(value1)) || value2 * 1 <=
            value1 * 1)) {
        layer.msg('请输入正确触发条件范围', {
            icon: 2,
            time: 1500
        ...
        return false;
    } else if (index == 4 && (!(!!value2 && !isNaN(value2)) || !(!!value1 && !isNaN(value1)) || value2 * 1 <=
            value1 * 1)) {
        layer.msg('请输入正确触发条件范围', {
            icon: 2,
            time: 1500
    ...
    postFnajax(postdata).then(function (res) {
        ...
        $.each(result.data, function (i, item) {
            if (item.DeviceCategory == "SENSOR") {
                SENSOR++;
                var img = '../../images/sensor_white/' + item.Slots[0].SensorTypeID + '.png';
                ...
                if (item.Slots[0].Alarm != null) {
                    ...
                    if (EnableHigh == true && HighValue != null && EnableLow == false && LowValue ==null) {
                        ...
                        danger = ((item.Slots[0].Data < LowValue) == true ? "level_two danger" : "level_two");
                    } else if (EnableHigh == true && HighValue != null && EnableLow == true && LowValue != null) {
                        if (HighValue < LowValue) { //两值之间
                            danger = ((HighValue < item.Slots[0].Data && item.Slots[0].Data <
                                LowValue) == true ? "level_two danger" : "level_two");
                        }
                        if (HighValue == LowValue) {
                            danger = ((HighValue == item.Slots[0].Data) == true ?
                                "level_two danger" : "level_two");
                        }
                        if (HighValue > LowValue) {
                            danger = ((HighValue < item.Slots[0].Data || item.Slots[0].Data <
                                LowValue) == true ? "level_two danger" : "level_two");
                ...
                Device += "<div class=\"alerm fl\" data-typeid=\"7288\" deviceId=\"" + item
                    .DeviceID + "\" deviceName=\"" + item.DeviceName + "\" slotId=\"" + item.Slots[
                        0].SlotID + "\" deviceTypeId=\"" + item.DeviceTypeID + "\"" +
                    "\" SUID = \"" + item.Slots[0].SUID + "\">";
                Device += "<img src=\".../../images/alert.png\" alt=\"\">报警设置</div>";
                Device += "<div class=\"history fr\" data-typeid=\"7288\" deviceId=\"" + item
                    .DeviceID + "\" deviceName=\"" + item.DeviceName + "\" slotId=\"" + item.Slots[
                        0].SlotID + "\" deviceTypeId=\"" + item.DeviceTypeID + "\" >";
